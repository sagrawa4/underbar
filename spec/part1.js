(function() {
  ...
  describe('Part I', function() {
    ...
    describe('first', function() {
      ...
      it('should return the first n elements if n is positive', function() {
    ...
    describe('last', function() {
      ...
      it('should return the last n elements if n is positive', function() {
    ...
    describe('indexOf', function() {
      ...
      it('returns -1 when the target cannot be found in the list', function() {
        var numbers = [10, 20, 30, 40, 50];
    ...
    describe('uniq', function() {
      ...
      it('should return all unique values from the input array when no iterator is provided as input', function() {
        var numbers = [1, 2, 1, 3, 1, 4];

        expect(_.uniq(numbers)).to.eql([1, 2, 3, 4]);
      });

      it('should return all unique values from the input array based on their transformed values if an iterator is provided as input', function() {
